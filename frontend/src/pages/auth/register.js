...
import { handleRegister } from '../../client/auth'; // Assuming handleRegister is updated
...
const RegisterPage = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const userProfile = await handleRegister(email, nickname, password);
      setSuccessMessage(`Registration successful for ${userProfile.nickname}! You can now log in.`);
